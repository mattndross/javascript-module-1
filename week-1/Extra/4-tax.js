...
function calculateSalesTax(salePrice) {
  const tax = 20;
  return (salePrice * tax) / 100 + salePrice;
}
...
function addTaxAndFormatCurrency(salePrice) {
  //const finalPrice = salePrice * 0.2 + salePrice;
  return `£${calculateSalesTax(salePrice).toFixed(2)}`
}
